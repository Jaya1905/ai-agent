...
export const getQuestionsByTag = (tagId) => api.get(`/api/questions/by-tag/${tagId}`);
...
export const getCallSession = (sessionId) => api.get(`/api/calls/session/${sessionId}`);
export const getLeadCallSessions = (leadId, params) => api.get(`/api/calls/lead/${leadId}`, { params });
